<?php
/**
 * Standalone install + heartbeat reporter for Panth_ThemeCustomizer.
 *
...
namespace Panth\ThemeCustomizer\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_ThemeCustomizer';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-theme-customizer';
