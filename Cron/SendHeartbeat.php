<?php
/**
 * Daily heartbeat cron for Panth_ThemeCustomizer. Skips if Panth_Core is
...
namespace Panth\ThemeCustomizer\Cron;

use Magento\Framework\Module\Manager as ModuleManager;
use Panth\ThemeCustomizer\Service\InstallReporter;
